...
1. A 6-week-old infant is brought in with jaundice, vomiting after feeding, and an enlarged liver. The parents say she was healthy at birth but has been declining since they started formula feeding. Her newborn screening came back abnormal for a metabolic disorder. A urine dipstick is negative for glucose but positive for a reducing sugar. What is the enzyme defect, and why is the sugar in her urine not glucose?

2. You are explaining to a patient why they cannot digest a salad but can digest bread, even though both are made largely of glucose. The patient is skeptical: "It's the same sugar." How would you explain why two materials made of identical building blocks behave completely differently in the human gut?

---

## The Big Picture

Carbohydrates are the most abundant organic molecules on Earth. If you weigh all the carbon locked in biological molecules, the majority of it is in carbohydrates: primarily cellulose in plant cell walls, and starch in plant seeds and tubers. By mass, life is overwhelmingly a carbohydrate phenomenon.

Yet the biochemistry curriculum has always treated carbohydrates as the least glamorous chapter. Proteins get allosterism and catalysis. Lipids get membrane architecture. Nucleic acids get the central dogma. Carbohydrates get: here are some rings, here is how to number the carbons, memorize the structures of glucose, galactose, and fructose.

This framing is wrong, and it matters for how you think about them. Carbohydrates are not just fuel. They are information. The specific sequence of monosaccharides in a polysaccharide, and the specific geometry of the bonds connecting them, encodes biological information just as surely as a sequence of amino acids does. The carbohydrate coat on the outside of every cell in your body, the glycocalyx, is a molecular identity card. The ABO blood groups are entirely determined by which sugars are added to glycoproteins on red blood cells. The reason a bacterium cannot infect a cell it has never encountered before, at least initially, is that it cannot read the carbohydrate code on the cell surface.

For this course, we will treat carbohydrates in three roles: as fuel (glucose and its storage forms), as structural material (cellulose, glycosaminoglycans), and as molecular identity tags (blood groups, glycoproteins). The chapter that covers glycolysis will take the metabolic story further. Here, the goal is to understand the structural chemistry well enough to make sense of why different carbohydrates behave so differently, why you can digest starch but not cellulose, why galactose is toxic in certain newborns, and why glycosylation of proteins matters for virtually every cell-cell interaction in your body.

The through-line for this chapter is lactose intolerance and galactosemia: two disorders of carbohydrate digestion and metabolism that affect different points in the same sugar-processing chain and illuminate the structural and enzymatic logic of carbohydrates better than any abstract description could.

---

## Monosaccharide Structure: The Basics
...
The naming convention: **D-sugars** have the hydroxyl on the highest-numbered chiral center (C5 in hexoses) pointing to the right in the Fischer projection. **L-sugars** are the mirror image. Nearly all biologically used sugars are D-configuration. This is a convention, not a rule of chemistry, but it is universal enough to be treated as a rule in biochemistry.

The key epimers for this course: **galactose** differs from glucose only at C4 (the hydroxyl is axial in galactose, equatorial in glucose). **Mannose** differs from glucose only at C2. These small differences matter enormously because the enzymes that metabolize these sugars are exquisitely stereospecific. Galactose and glucose are nearly identical molecules that require completely different enzymes to process.

### Ring Formation: Furanose and Pyranose Forms
...
The difference between $\alpha$ and $\beta$ at the anomeric carbon is a single stereochemical difference at a single carbon. But this difference completely changes the three-dimensional shape of polysaccharides built from that monomer, and that shape change is the molecular explanation for why starch and cellulose have such completely different properties.
...
A key conceptual point: the glucose units in glycogen are in the $\alpha$ configuration. When glycogen phosphorylase cleaves them off, it releases glucose-1-phosphate (not free glucose), which is converted to glucose-6-phosphate and enters glycolysis. In the liver, glucose-6-phosphatase can remove the phosphate to release free glucose into the blood. Muscle lacks glucose-6-phosphatase, so muscle glycogen cannot contribute directly to blood glucose: its glucose is trapped in muscle for local use.
...
The ABO blood group system is one of the clearest examples of carbohydrate as biological identity. The A, B, and O blood types are determined by which sugars are added to a carbohydrate chain (the H antigen) displayed on the surface of red blood cells and endothelial cells.

The H antigen is built from a core oligosaccharide and terminates in a fucose-galactose unit. From this common H antigen:

- **Blood type A**: a glycosyltransferase encoded by the A allele adds **N-acetylgalactosamine** to the galactose of the H antigen, creating the A antigen.
- **Blood type B**: a glycosyltransferase encoded by the B allele adds a **galactose** to the H antigen, creating the B antigen.
- **Blood type AB**: both transferases are expressed; both A and B antigens are present.
- **Blood type O**: the O allele encodes a nonfunctional enzyme with a frameshift mutation; neither sugar is added; the H antigen remains unmodified.

People produce antibodies against blood group antigens they do not carry. Type A individuals have anti-B antibodies. Type O individuals have both anti-A and anti-B antibodies. These antibodies mediate the transfusion reactions that occur when incompatible blood is transfused. The entire molecular basis of blood compatibility is which carbohydrates are present on cell surfaces.

This is a striking illustration of the chapter's central claim: carbohydrates carry biological information. The identity of a red blood cell as type A is written not in its protein or DNA sequence, but in the terminal sugar of a cell-surface oligosaccharide.
...
**Lactase deficiency** is the most common enzyme deficiency in the world. Most mammals, including most humans, downregulate lactase expression after weaning. The ability to digest lactose as an adult is a relatively recent evolutionary adaptation, arising independently in populations with a long history of dairying (Northern Europe, some East African pastoralist populations) through a mutation in a regulatory region upstream of the lactase gene.

Globally, most adults are **lactase non-persistent**: lactase expression declines after childhood. This is the ancestral state, not the disease. In populations where lactase persistence is uncommon (most of East Asia, West Africa, indigenous American populations), the majority of adults are lactose intolerant by the Northern European standard. Whether this represents "intolerance" or just the normal adult digestive state is partially a question of framing.
...
The **mucopolysaccharidoses (MPSs)** are lysosomal storage disorders caused by deficiencies in the enzymes that degrade glycosaminoglycans. Because the degradation is sequential (each enzyme removes one component from the chain), a deficiency at any step causes accumulation of the partially degraded GAG fragment in lysosomes throughout the body.

**Hurler syndrome (MPS I)**: deficiency of $\alpha$-L-iduronidase, required for degrading heparan sulfate and dermatan sulfate. Presents with coarse facial features, corneal clouding, intellectual disability, organomegaly, and skeletal abnormalities. The face and features result from GAG accumulation in connective tissue. Corneal clouding results from accumulation in the corneal stroma.

**Hunter syndrome (MPS II)**: the only X-linked MPS. Deficiency of iduronate-2-sulfatase. Similar features to MPS I but without corneal clouding (historically a distinguishing sign). The X-linkage means it affects almost exclusively males.

The general principle of the MPSs: GAGs are not just inert structural material. They are continuously turned over, and the degradation machinery matters as much as the biosynthetic machinery. When degradation fails, these large, highly charged polymers cannot be fully processed and accumulate in lysosomes, enlarging them and disrupting cell function in every tissue that contains connective tissue, which is nearly everywhere.
...
Carbohydrate MCAT questions cluster around three themes: stereochemistry, digestion, and clinical connections.
...
Carbohydrate MCAT questions often present a clinical scenario and ask you to reason backward to the molecular level. The key skill is connecting the structural detail (which bond, which configuration, which enzyme) to the clinical presentation (what accumulates, what fails, what symptoms result). This chapter has provided that chain of reasoning for several scenarios. Practice applying it to new scenarios: if you know the enzyme and its specificity, you can usually reconstruct the clinical consequence.
...
Two patients both have a deficiency of an enzyme in galactose metabolism. Patient A has cataracts but normal liver function and normal development. Patient B has liver failure, cataracts, and intellectual disability. What is each patient's enzyme deficiency, and what is the mechanistic basis for the severity difference?

**Reasoning:** Both patients have problems with galactose metabolism. The Leloir pathway is galactose $\to$ (galactokinase) $\to$ galactose-1-phosphate $\to$ (GALT) $\to$ UDP-galactose. Galactose that is not phosphorylated by galactokinase can be reduced by aldose reductase to galactitol, which accumulates in the lens and causes cataracts.

Patient A has cataracts only: galactose is not entering the Leloir pathway at all, so no galactose-1-phosphate accumulates. The disease is at the first step. Galactokinase deficiency means galactose accumulates and is reduced to galactitol, causing lens damage. Because galactose-1-phosphate never forms, the more toxic downstream effects are absent.

Patient B has liver failure, cataracts, and intellectual disability: this indicates galactose-1-phosphate accumulation. The enzyme deficiency is at the second step, GALT. Galactokinase works normally, so galactose is phosphorylated to galactose-1-phosphate, which then accumulates because GALT is absent. Galactose-1-phosphate is the toxic intermediate responsible for liver damage and neurotoxicity. Galactose is also still converted to galactitol, causing cataracts as in Patient A.

**Answer:** Patient A has galactokinase deficiency; Patient B has GALT deficiency (classic galactosemia). The severity difference reflects which intermediate accumulates: galactitol is toxic mainly to the lens, while galactose-1-phosphate is toxic to the liver, brain, and other tissues.
