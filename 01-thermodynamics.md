...
$$\text{Glucose} + \cancel{P_i} \rightarrow \text{Glucose-6-phosphate} + \cancel{H_2O} \qquad \Delta G^{\circ'} = +13.8 \text{ kJ/mol}$$

$$ATP + \cancel{H_2O} \rightarrow ADP + \cancel{P_i} \qquad \qquad \qquad \quad \Delta G^{\circ'} = -30.5 \text{ kJ/mol}$$

---

$$\text{Glucose} + ATP \rightarrow \text{Glucose-6-phosphate} + ADP \qquad \Delta G^{\circ'} = -16.7 \text{ kJ/mol}$$
